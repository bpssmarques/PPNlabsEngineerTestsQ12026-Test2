...
describe("GraphQL edge scenarios", function () {
    ...
    `;
      ...
      `,
        ...
        const connection1 = (page1Result.data as { payoutRequests?: PayoutRequestConnection })?.payoutRequests!;
      ...
      `,
        ...
        type Page2Connection = {
            edges: Array<{ node: { id: string } }>;
            pageInfo: { hasNextPage: boolean };
        };
        const connection2 = (page2Result.data as { payoutRequests?: Page2Connection })?.payoutRequests!;
